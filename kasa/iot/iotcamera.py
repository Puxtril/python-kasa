...
from .linkiemodules import VideoQuality, SDCard, NightVision, StreamToggle
...
class IotCamera(IotDevice):
    ...
    async def _initialize_modules(self) -> None:
        ...
        self.add_module(Module.LinkieVideoQuality, VideoQuality(self, "smartlife.cam.ipcamera.videoControl"))
